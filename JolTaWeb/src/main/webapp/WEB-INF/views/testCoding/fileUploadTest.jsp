	...
	function fn_xhr(obj, idx) {
		...
		obj.onreadystatechange = function() {
			...
			if(obj.readyState === 4 && obj.status === 200) {
				...
				if(type.match(/^text/) && success == filePctList.length) {location.href="/fileUploadComplete";}
			}
		};
...
<div style="position:relative; margin:0 auto;">
	...
	<div class="test_title">파일업로드</div>
		...
		<div id="fileTxBox" style=" width:100%; height:150px; border:2px solid #bbbbbb; border-radius:4px;"></div>
		<input type="button" id="fileUpload" value="파일 전송" onclick="fn_test();" style="width:100%; margin:10px 0 0 2px; background:#38ADC1; font-size:20px; font-weight:bold; color:white; height:50px;"/>
	</div>
	<div class="opacity_t file_wait_box" id="wait_tx">
		<div class="file_wait_tx">기다려주세요.......</div>
	</div>
</div>
</html>