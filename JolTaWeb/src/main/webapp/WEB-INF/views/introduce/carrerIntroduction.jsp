...
<div class="intro_frame">
	...
	<div>
		...
		<div class="intro_content_box">
			...
			<div class="tx_gap">
				<span class="s_tx_b_style">주요업무내용</span>
				<span class="s_tx_br_style">- PC웹사이트 공통팝업 개발 및 업무화면(등록, 수정 화면 등) 개발</span>
				<span class="s_tx_br_style">- 모바일웹(사용자, 공무원, 영업자) 개발</span>
				<span class="s_tx_br_style">- 모바일웹(사용자) 연계 데이터 조회</span>
				<span class="s_tx_br_style">- 모바일웹(공무원) 로그인, 업체점검 관리 등등</span>
				<span class="s_tx_br_style">- 모바일웹(영업자) 로그인, 축산물이력 관리 등등</span>
			</div>
		</div>
	</div>
	<br/>
	...
	<div>
		...
		<div class="intro_content_box">
			...
			<div class="tx_gap">
				<span class="s_tx_b_style">주사용 기술 </span> 
				<br/>
				<span class="s_tx_style">JAVA, ORACLE, EGOVFRAMEWORK</span>
			</div>
			<div class="tx_gap">
				<span class="s_tx_b_style">주요업무내용</span>
	...
	<div>
		...
		<div class="intro_content_box">
			<div><span class="s_tx_b_style">프로젝트명 </span><br/><span class="s_tx_style">축산차량 GPS 상황관리시스템 구축 및 업무시스템 개선 사업</span></div>
			<div class="tx_gap">
				<span class="s_tx_b_style">주사용 기술 </span> 
				<br/>
				<span class="s_tx_style">XFLATFORM, JAVA, JSP, JAVASCRIPT, JQUERY, HTML, CSS, ORACLE, EGOVFRAMEWORK</span>
			</div>
			<div class="tx_gap">
				<span class="s_tx_b_style">주요업무내용</span>
				<span class="s_tx_br_style">- XFLATFORM을 이용하여 꿀벌질병상담 업무시스템 화면(등록, 수정, 조회) 개발</span>
				<span class="s_tx_br_style">- 꿀벌질병상담 모바일웹 화면(꿀벌질병상담 등록, 수정, 조회) 개발</span>
				<span class="s_tx_br_style">- 꿀벌질병상담 건수 및 분포도 GIS 표시</span>
				<span class="s_tx_br_style">- 꿀벌질병상담 모바일웹 디자인 변경</span>
			</div>
		</div>
	</div>
	<br/>
